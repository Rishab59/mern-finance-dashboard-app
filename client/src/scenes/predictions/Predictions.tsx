...
const Predictions = () => {
    ...
    const formattedData = useMemo(() => {
        if (!kpiData) {
            return []; // to avoid errors, an empty array is returned if kpiData isn't available
        }
        ...
        return monthlyData.map(
            ({ month, revenue }, i:number) => {
                return {
                    ...
                    "Predicted Revenue": regressionLine.predict(i + 12)[1], // predicts next year so only + 12
                }
            }
        );
    }, [kpiData]);
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {
                        isPredictions ? "Hide Prediction" : "Show Predicted Revenue for next year"
                    }
                </Button>
            </FlexBetween>
